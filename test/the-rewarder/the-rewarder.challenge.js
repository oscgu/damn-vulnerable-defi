...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerContract = await ethers.getContractFactory("Attacker4", attacker);
        this.attackerContract = await AttackerContract.deploy(this.rewarderPool.address, this.flashLoanPool.address, this.liquidityToken.address, this.rewardToken.address);

        await this.attackerContract.connect(attacker).exploit(TOKENS_IN_LENDER_POOL);
    });
